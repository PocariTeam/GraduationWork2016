...
enum eRendergroup { RENDER_SHADOW, RENDER_BACKGROUND, RENDER_DEPTHTEST, RENDER_OUTCAVE, RENDER_LIGHT, RENDER_BLEND, RENDER_ALPHA, RENDER_INCAVE, RENDER_UI, RENDER_DEBUG, RENDER_END };
